...
<div id="bottom">
    ...
    <div id="bottomForm" style="display: none">
        <form:form method="get" commandName="options">
            <table>
                <tr>
                    <td>
                    ...
                    <td>
                        ...
                        <div style="height: 160pt; overflow-y: auto; border: 1px solid #FFCC00">
                            ...
                            <p>
                                <form:checkbox id="hideGreenBuilds" path="hideGreenBuilds"/>
                                <label for="hideGreenBuilds">Don't Show Green Builds</label>
                            </p>
                            ...
                            <form:hidden id="debug" path="debug"/>
                        </div>
                    </td>
                </tr>
            </table>
